...
1665 IF J=5 THEN X(J)=174.0104: Y(J)=172.0512: D(J)=2022.1686
...
1710 IF J=5 THEN PRINT "     YECH! OVER 66 FEET AWAY!": PRINT "SHORT AND TO THE RIGHT": PRINT
